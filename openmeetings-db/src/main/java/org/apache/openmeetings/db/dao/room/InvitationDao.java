...
public class InvitationDao implements IDataProviderDao<Invitation> {
	...
	public List<Invitation> getByUser(Long userId) {
		return em.createNamedQuery("getInvitationByInvitee", Invitation.class)
				.setParameter("inviteeId", userId).getResultList();
	}
